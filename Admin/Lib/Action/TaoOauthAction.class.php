...
class TaoOauthAction extends BaseAction {
	function index() {
		...
		$redirect_uri = $this -> site_root . "admin.php?m=taoOauth&state=1";
		...
		//自动刷新令牌refresh_token
		$postfields2 = array('grant_type' => 'refresh_token', 'client_id' => $client_id, 'client_secret' => $client_secret, 'refresh_token' => $token['refresh_token']);
		$url = 'https://oauth.taobao.com/token';
