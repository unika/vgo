...
class UcenterAction extends BaseAction {
	function setucenter() {
		$config = array('dbhost' => "'" . C('DB_HOST') . "';", 'dbuser' => "'" . C("DB_USER") . "';", 'dbpw' => "'" . C("DB_PWD") . "';", 'dbname' => "'" . C("DB_NAME") . "';", 'pconnect' => "0;", 'tablepre' => "'`" . C("DB_NAME") . "`." . C("DB_PREFIX") . "';", 'dbcharset' => "'utf8';", 'cookiedomain' => "'';", 'cookiepath' => "'/';");
