...
class Items_tagsModel extends RelationModel {
	protected $_link = array('items_cate' => array('mapping_type' => MANY_TO_MANY, 'class_name' => 'items_cate', 'foreign_key' => 'tag_id', 'relation_foreign_key' => 'cate_id', 'relation_table' => 'items_tags_cate', 'auto_prefix' => true));
	//分词函数
