...
<html xmlns="http://www.w3.org/1999/xhtml" class="off">
	...
	<body scroll="no">
		<div id="header">
			<div class="logo">
				<a href="__APP__" title="<?php echo (L("website_manage")); ?>"></a>
			</div>
			<div class="fr">
			...
			<div class="col-auto" style="overflow: visible">
				<div class="log white cut_line">
					...
					|
					<a href="<?php echo ($site_root); ?>" target="_blank">[站点首页]</a> | <a href="<?php echo U('public/logout');?>">[<?php echo (L("logout")); ?>]</a>
				</div>
			...
			<div class="right_main">
				<div class="crumbs">
					<div class="shortcut cu-span">
						<a href="<?php echo ($site_root); ?>" target="_blank"> <span><?php echo (L("site_home")); ?></span> </a>
						<a href="<?php echo U('Cache/index');?>" target="right"> <span><?php echo (L("flush_cache")); ?></span> </a>
					</div>
		...
		<script>
			...
			function _M(tag, targetUrl) {
				...
				$.get("<?php echo U('Index/current_pos');?>", {
					tag : tag
				}, function(data) {
					$("#current_pos").html(data);
				});
