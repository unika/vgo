...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="showMsg" style="text-align:center">
			...
			<?php if(isset($message)): ?><div class="content guery" style="display:inline-block;display:-moz-inline-stack;zoom:1;*display:inline;max-width:330px;">
					<?php echo ($message); ?>
				</div><?php endif; ?>
			<div class="bottom">
...
setTimeout("redirect('<?php echo ($jumpUrl); ?>');",<?php echo ($waitSecond); ?>*1000);
				...
				<?php if(isset($returnjs)): ?><script style="text/javascript">
						{ $returnjs
						};
					</script><?php endif; ?>
